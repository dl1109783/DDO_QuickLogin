...
namespace QuickLogin.Connect
{
    ...
    public class ConnectThread
    {
        ...
        private string GetDes(string strKey)
        {
            ...
            hs.Add("EDTomeFeywild", "新天命书-Feywild");
            hs.Add("EDTomeMotU", "新天命书-MotU");
            ...
            hs.Add("estore_Content_EveningstarAdventures", "U14:伊尔明斯特(C1)");
            hs.Add("estore_Content_EveningstarChallenges", "U14:伊尔明斯特挑战(C1)");
            hs.Add("estore_Content_EveningstarLandscape", "U14:伊尔明斯特野外(C1)");
            hs.Add("estore_Content_UnderdarkAdventures", "U14:黑暗地域(C2)");
            hs.Add("estore_Content_UnderdarkLandscape", "U14:黑暗地域野外(C2)");
            hs.Add("estore_Content_DemonwebAdventures", "U14:恶魔蛛网(C3-Raid)");
            hs.Add("estore_Content_DemonwebLandscape", "U14:恶魔蛛网野外(C3)");
        ...
        private string GetProductTokens(List<string> p_strProductTokens)
        {
            ...
            foreach (string _strProduct in p_strProductTokens)
            {
                ...
                else if (_strTemp.ToUpper().IndexOf("FEATURE") >= 0 || _strTemp.ToUpper().IndexOf("ES_ACCTBANK") >= 0)
                {
