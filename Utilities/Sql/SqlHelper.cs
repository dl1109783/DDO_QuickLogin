...
namespace Utilities.Sql
{
    public sealed class SqlHelper
    {
        ...
        {
            return ExecuteNonQuery(GetConnSting(), commandType, commandText, (SqlParameter[])null);
        }
        ...
        {
            // 执行参数为空的方法
            return ExecuteScalar(GetConnSting(), commandType, commandText, (SqlParameter[])null);
        }
        ...
        public static int ExecuteSqlTran(List<String> SQLStringList)
        {
            using (SqlConnection conn = new SqlConnection(GetConnSting()))
            {
                ...
                {
                    Utilities.General.Log.Error(ex.Message);
                    tx.Rollback();
                    return 0;
                }
            }
